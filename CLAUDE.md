...
- Decrypt timing: `CLOUDFLARE_API_TOKEN` at TF runtime; `TAILSCALE_AUTH_KEY`, `POSTGRESQL_REMOTE_PASSWORD`, `LOGFIRE_READ_TOKEN`, `ANTHROPIC_API_KEY`, `GITHUB_TOKEN` at Ansible runtime via `gce-configure` / `leadpilot-deploy` / `mailpilot-deploy`
