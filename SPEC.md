...
|T17|.|fix V3 quoting @ `ansible/roles/claude_code/tasks/main.yaml:47` — `loop:` value → single-quoted (`loop: '{{ claude_settings.extraKnownMarketplaces \| dict2items }}'`); re-run V3 spot-grep to confirm sole instance|V3
