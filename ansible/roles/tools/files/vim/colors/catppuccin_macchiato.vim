...
call s:hi("ErrorMsg", "NONE", s:red, "NONE", "bold", "bold")
...
call s:hi("GitGutterAdd", "NONE", s:green, "NONE", "NONE", "NONE")
call s:hi("GitGutterChange", "NONE", s:yellow, "NONE", "NONE", "NONE")
call s:hi("GitGutterDelete", "NONE", s:red, "NONE", "NONE", "NONE")
call s:hi("GitGutterAddIntraLine", "NONE", s:base, s:green, "NONE", "NONE")
call s:hi("GitGutterDeleteIntraLine", "NONE", s:base, s:maroon, "NONE", "NONE")
